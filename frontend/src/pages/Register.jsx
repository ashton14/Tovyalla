      ...
      <div className="relative w-full max-w-5xl z-10">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
          <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
            ...
            <div className="p-6 lg:p-7 bg-gradient-to-br from-gray-50 to-gray-100">
              <div className="mb-5">
                <div className="inline-flex items-center justify-center w-11 h-11 bg-gradient-to-br from-pool-blue to-pool-dark rounded-xl mb-3 shadow-lg">
              ...
              {/* Pricing Card */}
              <div className="bg-white rounded-xl p-5 shadow-lg border border-gray-200 mb-4">
                <div className="text-center mb-2">
                  <span className="text-sm font-medium text-pool-blue bg-pool-light px-3 py-1 rounded-full">
                    Business Plan
                  </span>
                </div>
                ...
                <a
                  href=""
                  className="block w-full bg-gradient-to-r from-pool-blue to-pool-dark hover:from-pool-dark hover:to-pool-blue text-white font-semibold py-2.5 px-4 rounded-lg transition-all duration-300 text-center shadow-lg shadow-pool-blue/25 hover:shadow-pool-dark/30"
                >
                  Get Started
                </a>
              </div>

    ...
    <div className="relative min-h-screen w-screen overflow-hidden flex items-center justify-center p-4">
      <div className="relative w-full max-w-lg z-10">
        ...
        <div className="text-center mb-8">
          <img src="/tovyalla_logo.png" alt="Tovyalla CRM" className="h-24 w-auto mx-auto mb-3" />
          <p className="text-white/80 text-lg font-light">Customer Relationship Management</p>
        </div>

        {/* Login Card */}
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
          {/* Card Header */}
          <div className="bg-gradient-to-r from-pool-blue to-pool-dark px-8 py-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-pool-blue focus:border-transparent transition-all bg-gray-50 hover:bg-white"
